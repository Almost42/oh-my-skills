...
- session candidates
- 当前活跃 spec 与验证结果
- 已有 owner 文档（`docs/ai/domain_rules.md`、`docs/ai/architecture.md`、capability docs）
...
- `promote to docs/ai/domain_rules.md`
- `promote to docs/ai/architecture.md`
...
**Owner 决策**:
- 保留在 lessons | 合并进已有 lesson | 升格到 `docs/ai/domain_rules.md` | 升格到 `docs/ai/architecture.md` | 升格到 capability doc | 作为一次性内容丢弃
