...
- `docs/ai/spec/index.md` 是 spec 根索引，创建或修订 spec 时同步更新，但节点真相仍在 spec 状态锚点。

## Patch → Single-file mode

- 文件：`docs/ai/spec/YYYY-MM-DD-{slug}.md`
...
正反例：
- ✅ Feature 类需求 → 创建 `docs/ai/spec/2026-04-20-create-task/index.md` + `req.md` + `design.md` + `impl.md`（空），并更新 `docs/ai/spec/index.md`
